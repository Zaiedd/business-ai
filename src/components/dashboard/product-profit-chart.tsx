    ...
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={sorted} layout="vertical" margin={{ top: 0, right: 24, left: 8, bottom: 0 }}>
        ...
        <Tooltip
          ...
          formatter={(value: number) => stripBidi(new Intl.NumberFormat(locale === "ar" ? "ar-EG" : "en-US", { style: "currency", currency, maximumFractionDigits: 0 }).format(value))}
        />
        <Bar dataKey="profit" name={t("dashboard.charts.profit")} fill="#2563eb" radius={[0, 6, 6, 0]} barSize={18} />
      </BarChart>
    </ResponsiveContainer>
  );
}
